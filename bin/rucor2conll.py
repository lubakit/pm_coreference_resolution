...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Convert Russian coreference data set to the CONLL format.')
    parser.add_argument('-i', '--input-dir', dest='input_dir', type=str, help='dir containing the coreference data files.')
    parser.add_argument('-o', '--output-dir', dest='output_dir', type=str, help='dir to store the converted file(s).')
    args = parser.parse_args()
    if args.input_dir is None or args.output_dir is None:
        parser.print_usage()
        sys.exit(-1)
    RuCoref2CoNLL(args.input_dir, args.output_dir)